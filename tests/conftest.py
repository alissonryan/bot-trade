...
_SETTINGS_ENV_VARS = (
    ...
    "FUT_MAX_HOLD_SECONDS", "FUT_MIN_HOLD_SECONDS", "FUT_MAX_SPREAD_BPS", "FUT_MIN_MOVE_MULT",
    "FUT_MAX_ENTRIES_PER_HOUR", "FUT_MIN_CONFIDENCE", "FUT_JEV_EVERY_SECONDS", "FUT_JEV_MODEL",
    "FUT_JEV_USD_PER_MTOK", "FUT_JEV_TIMEOUT_SECONDS", "FUT_WAKE_THRESHOLD", "FUT_WAKE_STREAK",
    "FUT_WAKE_REGIMES", "FUT_MOVE_COST_BPS",
