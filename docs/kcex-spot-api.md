...
Min15 historical capture (2026-09-06): the earliest available BTC_USDT bar was
2023-06-30 16:00 UTC (`1688140800`); requests returned at most 5,000 points.
Use paginated millisecond `start`/`end` requests and validate continuity of the
returned second-based timestamps. The local capture contains 111,773 contiguous
Min15 bars; this is observed coverage, not a promise of permanent retention.
